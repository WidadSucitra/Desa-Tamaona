...
if(isset($_POST['submit_delete'])){
  $wisata_id = $_POST['submit_delete'];

  $check_img_query = "SELECT * FROM potensi_wisata WHERE id=$wisata_id' LIMIT 1";
  $img_res = mysqli_query($conn,$query);
  $res_data = mysqli_fetch_array($img_res);

  $image = $res_data['gambar'];

  $query = "DELETE FROM potensi_wisata WHERE id='$wisata_id' LIMIT 1";
  ...
  if($query_run)
    {
      if(file_exists('../uploads/potensi_wisata/'.$image)){
          unlink("../uploads/potensi_wisata/'.$image");
      }
...
?>
        ...
        <div class="container-fluid">
          <section class="index-galeri">
            ...
            <button class="btn-index-galeri"><a href="create.php">Tambah Wisata</a></button>
